    ...
    <footer className="bg-earth-dark text-white py-12">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="transform transition-all duration-300 hover:translate-y-[-4px]">
            ...
            <p className="text-earth-clay leading-relaxed">
              Handcrafted clay sculptures that celebrate the beauty of earth. Each piece is molded with passion and fired with tradition.
            </p>
          </div>
          ...
          <div className="transform transition-all duration-300 hover:translate-y-[-4px]">
            ...
            <div className="space-y-3">
              <p className="text-earth-clay hover:text-white transition-colors duration-300">
                <span className="font-semibold">Email:</span> clay@claycraft.com
              </p>
              <p className="text-earth-clay hover:text-white transition-colors duration-300">
              ...
              <div className="flex space-x-4 mt-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-white text-earth-dark rounded-full flex items-center justify-center hover:bg-terracotta hover:text-white transition-all duration-300 transform hover:scale-110 hover:rotate-12"
        ...
        <div className="border-t border-earth-light mt-8 pt-8 text-center">
          <p className="text-earth-clay hover:text-white transition-colors duration-300">
            &copy; {currentYear} ClayCraft Studio. All rights reserved. Handcrafted with ❤️ and clay.
          </p>
        </div>
      </div>
    </footer>
